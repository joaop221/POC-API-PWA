...
namespace Utilidades.Modelo.Tratamento
{
	/// <summary>
	/// Modelo de exceção de dados
	/// </summary>
	public class DadosExcecao : Exception
	{
		...
		/// </summary>
		public DadosExcecao(string mensagemAmigavel) : base(mensagemAmigavel)
		{
		...
		/// </summary>
		public DadosExcecao(int codigo, string mensagemAmigavel) : base(mensagemAmigavel)
		{
			this.Codigo = codigo;
			this.Mensagem = mensagemAmigavel;
		}
		...
		/// </summary>
		public DadosExcecao(int codigo, string mensagemAmigavel, Exception innerException)
